...
class conv1d(Policy):
    def forward(
        ...
        self.ctx.save(input, weight, bias, stride, padding, dilation, groups)
    ...
    def backward(self, grad_output):
        input, weight, bias, stride, padding, dilation, groups = self.ctx.release
...
class conv3d(Policy):
    ...
    def backward(self, grad_output):
        ...
        grad_bias = grad_output.sum(dim=(0, 2, 3, 4)) if bias is not None else None
